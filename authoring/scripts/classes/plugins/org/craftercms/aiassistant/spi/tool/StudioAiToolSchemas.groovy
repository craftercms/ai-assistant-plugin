...
/**
 * JSON Schema strings for built-in tools on the chat-completions tools-loop wire (must match {@link plugins.org.craftercms.aiassistant.engine.catalog.AiOrchestrationTools}).
 */
