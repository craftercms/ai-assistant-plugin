package plugins.org.craftercms.aiassistant.engine.turn.chatcompletions
...
private ChatCompletionsToolWire() {}
  ...
  /**
   * Native tool call id binding set.
   * @param toolCallId Identifier for the target resource.
   */
  ...
  /**
   * Native tool call id binding clear.
   */
  ...
  /**
   * Native tool call id binding get.
  ...
  /**
   * Generate image backlog tool call id.
   * @param gm Caller-supplied input.
   * @return Text result, or empty or null when unavailable.
   */
  ...
  /**
   * Generate image result url string.
   * @param m Caller-supplied input.
   * @return Text result, or empty or null when unavailable.
   */
  ...
  /**
   * Merges backlog into eff without dropping prior conversation context.
   */
