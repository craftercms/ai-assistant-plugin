package plugins.org.craftercms.aiassistant.engine.rag
...
class ExpertSkillVectorRegistry {
  ...
  static void ensureCorpusLoaded(
    ...
    synchronized (lk) {
      ...
      def fetch = plugins.org.craftercms.aiassistant.contrib.tool.builtin.http.HttpUrlFetch.fetch(sourceUrl, null)
