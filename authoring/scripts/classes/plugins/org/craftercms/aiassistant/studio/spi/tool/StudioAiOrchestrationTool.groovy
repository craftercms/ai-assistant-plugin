...
interface StudioAiOrchestrationTool {
  ...
  /**
   * When {@code true}, {@link plugins.org.craftercms.aiassistant.studio.engine.routing.subrouting.AuthoringIntentRecipeEngine}
   ...
   * {@link plugins.org.craftercms.aiassistant.studio.engine.catalog.StudioAiToolRegistry#mergeRecipeConfirmationArgs}.</p>
   *
