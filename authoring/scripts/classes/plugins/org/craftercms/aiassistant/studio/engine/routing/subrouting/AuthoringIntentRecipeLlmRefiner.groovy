...
import plugins.org.craftercms.aiassistant.studio.contrib.tool.builtin.integrations.SlackConfirmationPostFormatter
...
private AuthoringIntentRecipeLlmRefiner() {}
  ...
  /**
   * Headings from passthrough value.
  ...
  /**
   * Extracts first section for headings from repository XML or related text.
   * @param sourceMarkdown Caller-supplied input.
   * @param headings Caller-supplied input.
  ...
  /**
   * Generate passthrough fallback key.
   * @return Text result, or empty or null when unavailable.
   */
  ...
  /**
   * Append passthrough fallback hints.
   * @param user Caller-supplied input.
   * @param refineStep Caller-supplied input.
  ...
  /**
   * Passthrough fallback max out tokens.
   ...
   * @param payload Caller-supplied input.
   * @param requiredKeys Caller-supplied input.
   * @return List<String> result.
   */
  ...
  /**
   * Normalizes and validates payload strings; throws when required values are missing.
   * @param payload Caller-supplied input.
  ...
  /**
   * Builds author preview markdown for tool or orchestration output.
   * @param payload Caller-supplied input.
   * @param keyOrder Caller-supplied input.
   * @return Text result, or empty or null when unavailable.
   */
  ...
  /**
   * Structured json max out tokens.
   * @param projectCfg Caller-supplied input.
   * @param keyCount Caller-supplied input.
   * @return int result.
   */
  ...
  /**
   * Resolves markdown system prompt from request and plugin context.
   * @param refineStep Caller-supplied input.
   * @return Text result, or empty or null when unavailable.
   */
  ...
  /**
   * Resolves structured json system prompt from request and plugin context.
   * @param refineStep Caller-supplied input.
   * @param outputKeys Caller-supplied input.
   * @return Text result, or empty or null when unavailable.
   */
