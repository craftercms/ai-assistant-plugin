...
- **UI / script hardening (checklist)** — When changing React chat or Groovy in-memory stores / executors, skim **[`docs/internals/maintainer-review-checklist.md`](docs/internals/maintainer-review-checklist.md)** so recurring review themes (localStorage + SSE, bounded logs, Studio user identity, promise-cache eviction, SSE terminal races, deep copies, thread-pool rejection policy) stay top of mind.
