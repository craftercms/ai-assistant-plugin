...
| [**chat-and-tools-runtime.md**](chat-and-tools-runtime.md) | tool wiring, MCP, **plugin RAG** (system prompt) vs **agent skills RAG** (`QueryExpertGuidance`), SSE/stream behavior, REST body fields (**working vs session `siteId`**), troubleshooting |
