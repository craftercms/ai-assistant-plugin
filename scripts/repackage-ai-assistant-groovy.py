...
MOVES: list[tuple[str, str]] = [
    ...
    # engine/routing
    ("recipes/AuthoringIntentRecipeCatalog.groovy", "engine/routing/AuthoringIntentRecipeCatalog.groovy"),
    ("recipes/AuthoringIntentRecipeEngine.groovy", "engine/routing/AuthoringIntentRecipeEngine.groovy"),
    ("recipes/AuthoringIntentRecipeWhen.groovy", "engine/routing/AuthoringIntentRecipeWhen.groovy"),
    ("recipes/AuthoringIntentRecipeBindings.groovy", "engine/routing/AuthoringIntentRecipeBindings.groovy"),
    ("recipes/AuthoringIntentRecipeLlmRefiner.groovy", "engine/routing/AuthoringIntentRecipeLlmRefiner.groovy"),
    ("recipes/AuthoringIntentRecipePlanCompiler.groovy", "engine/routing/AuthoringIntentRecipePlanCompiler.groovy"),
    ("recipes/AuthoringIntentRecipeRouter.groovy", "engine/routing/AuthoringIntentRecipeRouter.groovy"),
    ("recipes/AuthoringIntentRoutingEngine.groovy", "engine/routing/AuthoringIntentRoutingEngine.groovy"),
    ("recipes/AuthoringIntentSiteToolCatalog.groovy", "engine/routing/AuthoringIntentSiteToolCatalog.groovy"),
    ("recipes/PriorConversationDraftExtract.groovy", "engine/routing/PriorConversationDraftExtract.groovy"),
    ("recipes/ToolsLoopWriteVerification.groovy", "engine/routing/ToolsLoopWriteVerification.groovy"),
    ("recipes/RecipeMarkdownSections.groovy", "engine/routing/RecipeMarkdownSections.groovy"),
    ("recipes/StudioRecipeClockTemplates.groovy", "engine/routing/StudioRecipeClockTemplates.groovy"),
